    ...
    <div class="w-10/12 mx-auto mt-12 mb-36">
        ...
        <div class="content">
            <div class="header capitalize font-semibold grid grid-cols-7 w-full">
                ...
                <div class="col-span-1 ml-8">Date</div>
            ...
            @forelse ($orders as $order)
                <div class="header capitalize font-semibold grid grid-cols-7 w-full text-left mb-6">
                    ...
                    <div class="col-span-2 h-16 flex items-center ml-8 text-gray-500">
                    ...
                    <div class="col-span-1 h-16 flex items-center @if ($order->status->value == 'delivered') text-green-500 @else text-red-500 @endif"
